...
siderigth_vec=[515.078335690855,-1310.25037092236,4.08281322017900]-[5.133729973152860e+02,-1.309057917884610e+03,4.003824605768490];
siderigth_vec=siderigth_vec/norm(siderigth_vec);
% temp=PointCloud(end-288+1:end,:);
% temp=[PointCloud(end-288*20+1:end,:);temp+10*siderigth_vec];
% pcshow(temp)
height_vec=cross(siderigth_vec,outter_vec);
